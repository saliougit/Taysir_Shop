      ...
      {if $field.type === 'select'}
        ...
        {block name='form_field_item_select'}
          <select id="field-{$field.name}" class="form-control form-control-select" name="{$field.name}" {if $field.required}required{/if}>
            <option value disabled selected>{if $smarty.const._PS_VERSION_ >= '8.0.0'}{l s='Please choose' d='Shop.Forms.Labels'}{else}{l s='-- please choose --' d='Shop.Forms.Labels'}{/if}</option>
        ...
        {block name='form_field_item_checkbox'}
          <span class="custom-checkbox">
            <label>
              ...
              <span class="checkbox-content">{$field.label nofilter}</span>
            </label>
          </span>
        {/block}
        ...
        {block name='form_field_item_password'}
          <div class="input-group js-parent-focus">
            <input
              ...
              {if $smarty.const._PS_VERSION_ >= '1.7.8.0'}{if $field.autocomplete}autocomplete="{$field.autocomplete}"{/if}{/if}
              value=""
