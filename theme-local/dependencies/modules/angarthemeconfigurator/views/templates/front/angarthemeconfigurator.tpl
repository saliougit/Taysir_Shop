...
<div class="panel">
	...
	<div class="customization_title" data-toggle="collapse" data-parent="#accordion" data-target="#customization_box19">{l s='Page width' mod='angarthemeconfigurator'}</div>
	<div id="customization_box19" class="collapse customization_container">	

		<div class="page_width">
			<label class="options_title">{l s='Page width:' mod='angarthemeconfigurator'}</label></br>

			<label class="page_width_1200"><input type="radio" name="angarconfig_input65" value="page_width_1200" {if $css65 == page_width_1200}checked{/if}>{l s='Page width 1200px' mod='angarthemeconfigurator'}</label></br>
			<label class="page_width_1300"><input type="radio" name="angarconfig_input65" value="page_width_1300" {if $css65 == page_width_1300}checked{/if}>{l s='Page width 1300px' mod='angarthemeconfigurator'}</label></br>
			<label class="page_width_1400"><input type="radio" name="angarconfig_input65" value="page_width_1400" {if $css65 == page_width_1400}checked{/if}>{l s='Page width 1400px' mod='angarthemeconfigurator'}</label></br>
			<label class="page_width_1500"><input type="radio" name="angarconfig_input65" value="page_width_1500" {if $css65 == page_width_1500}checked{/if}>{l s='Page width 1500px' mod='angarthemeconfigurator'}</label></br>
			<label class="page_width_1600"><input type="radio" name="angarconfig_input65" value="page_width_1600" {if $css65 == page_width_1600}checked{/if}>{l s='Page width 1600px' mod='angarthemeconfigurator'}</label></br>
			<label class="page_width_1700"><input type="radio" name="angarconfig_input65" value="page_width_1700" {if $css65 == page_width_1700}checked{/if}>{l s='Page width 1700px' mod='angarthemeconfigurator'}</label></br>
			<label class="page_width_1800"><input type="radio" name="angarconfig_input65" value="page_width_1800" {if $css65 == page_width_1800}checked{/if}>{l s='Page width 1800px' mod='angarthemeconfigurator'}</label></br>
			<label class="page_width_1900"><input type="radio" name="angarconfig_input65" value="page_width_1900" {if $css65 == page_width_1900}checked{/if}>{l s='Page width 1900px' mod='angarthemeconfigurator'}</label></br>
		</div>
...
{*
	...
	<div id="customization_box3" class="collapse customization_container">
		...
		<div class="header_style">
			...
			<label class="header_style_1"><input type="radio" name="angarconfig_input64" value="header_style_1" {if $css64 == header_style_1}checked{/if}>{l s='Header style 1' mod='angarthemeconfigurator'}</label></br>
			<label class="header_style_2"><input type="radio" name="angarconfig_input64" value="header_style_2" {if $css64 == header_style_2}checked{/if}>{l s='Header style 2' mod='angarthemeconfigurator'}</label></br>
			<label class="header_style_3"><input type="radio" name="angarconfig_input64" value="header_style_3" {if $css64 == header_style_3}checked{/if}>{l s='Header style 3' mod='angarthemeconfigurator'}</label>
		</div>
...
*}
	...
	<div id="customization_box14" class="collapse customization_container">
		...
		<div class="pl_qty">
			<label class="options_title">{l s='Hide qty field in the product-list:' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_qty_yes"><input type="radio" name="angarconfig_input66" value="pl_qty_yes" {if $css66 == pl_qty_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_qty_no"><input type="radio" name="angarconfig_input66" value="pl_qty_no" {if $css66 == pl_qty_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>
		...
		<div class="pl_stock">
			<label class="options_title">{l s='Hide stock in the product-list:' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_stock_yes"><input type="radio" name="angarconfig_input67" value="pl_stock_yes" {if $css67 == pl_stock_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_stock_no"><input type="radio" name="angarconfig_input67" value="pl_stock_no" {if $css67 == pl_stock_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>
...
{*
		<div class="footer_style">
			<label class="options_title">{l s='Footer style:' mod='angarthemeconfigurator'}</label></br>
			<label class="footer_style_1"><input type="radio" name="angarconfig_input76" value="footer_style_1" {if $css76 == footer_style_1}checked{/if}>{l s='Footer style 1' mod='angarthemeconfigurator'}</label></br>
			<label class="footer_style_2"><input type="radio" name="angarconfig_input76" value="footer_style_2" {if $css76 == footer_style_2}checked{/if}>{l s='Footer style 2' mod='angarthemeconfigurator'}</label></br>
			<label class="footer_style_3"><input type="radio" name="angarconfig_input76" value="footer_style_3" {if $css76 == footer_style_3}checked{/if}>{l s='Footer style 3' mod='angarthemeconfigurator'}</label></br>
		</div>
*}
...
*}
		...
		<div class="product_stock">
			<label class="options_title">{l s='Hide stock on the product page:' mod='angarthemeconfigurator'}</label></br>
			<label class="product_stock_yes"><input type="radio" name="angarconfig_input68" value="product_stock_yes" {if $css68 == product_stock_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="product_stock_no"><input type="radio" name="angarconfig_input68" value="product_stock_no" {if $css68 == product_stock_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>
	...
	<div class="customization_title" data-toggle="collapse" data-parent="#accordion" data-target="#customization_box23">{l s='Category page' mod='angarthemeconfigurator'}</div>
	<div id="customization_box23" class="collapse customization_container">	

		<div class="category_main_image">
			<label class="options_title">{l s='Hide category main image:' mod='angarthemeconfigurator'}</label></br>
			<label class="cat_image_yes"><input type="radio" name="angarconfig_input69" value="cat_image_yes" {if $css69 == cat_image_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="cat_image_no"><input type="radio" name="angarconfig_input69" value="cat_image_no" {if $css69 == cat_image_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label></br>
		</div>

		<div class="category_desc_mobile">
			<label class="options_title">{l s='Hide category description on mobile:' mod='angarthemeconfigurator'}</label></br>
			<label class="cat_desc_mobile_yes"><input type="radio" name="angarconfig_input70" value="cat_desc_mobile_yes" {if $css70 == cat_desc_mobile_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="cat_desc_mobile_no"><input type="radio" name="angarconfig_input70" value="cat_desc_mobile_no" {if $css70 == cat_desc_mobile_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label></br>
		</div>

		<div class="subcat_image">
			<label class="options_title">{l s='Hide subcategories image:' mod='angarthemeconfigurator'}</label></br>
			<label class="subcat_image_yes"><input type="radio" name="angarconfig_input71" value="subcat_image_yes" {if $css71 == subcat_image_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="subcat_image_no"><input type="radio" name="angarconfig_input71" value="subcat_image_no" {if $css71 == subcat_image_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label></br>
		</div>

		<div class="subcat_style">
			<label class="options_title">{l s='Subcategory style:' mod='angarthemeconfigurator'}</label></br>
			<label class="subcat_style_0"><input type="radio" name="angarconfig_input72" value="subcat_style_0" {if $css72 == subcat_style_0}checked{/if}>{l s='Subcategory style default' mod='angarthemeconfigurator'}</label></br>
			<label class="subcat_style_1"><input type="radio" name="angarconfig_input72" value="subcat_style_1" {if $css72 == subcat_style_1}checked{/if}>{l s='Subcategory style 1' mod='angarthemeconfigurator'}</label></br>
			<label class="subcat_style_2"><input type="radio" name="angarconfig_input72" value="subcat_style_2" {if $css72 == subcat_style_2}checked{/if}>{l s='Subcategory style 2' mod='angarthemeconfigurator'}</label></br>
			<label class="subcat_style_3"><input type="radio" name="angarconfig_input72" value="subcat_style_3" {if $css72 == subcat_style_3}checked{/if}>{l s='Subcategory style 3' mod='angarthemeconfigurator'}</label></br>
		</div>

		<div class="subcat_per_row">
			<label class="options_title">{l s='Subcategories per row:' mod='angarthemeconfigurator'}</label></br>
			<label class="subcat_qty_0"><input type="radio" name="angarconfig_input73" value="subcat_qty_0" {if $css73 == subcat_qty_0}checked{/if}>{l s='hide subcategories' mod='angarthemeconfigurator'}</label></br>
			<label class="subcat_qty_2"><input type="radio" name="angarconfig_input73" value="subcat_qty_2" {if $css73 == subcat_qty_2}checked{/if}>{l s='2 categories per row' mod='angarthemeconfigurator'}</label></br>
			<label class="subcat_qty_3"><input type="radio" name="angarconfig_input73" value="subcat_qty_3" {if $css73 == subcat_qty_3}checked{/if}>{l s='3 categories per row' mod='angarthemeconfigurator'}</label></br>
			<label class="subcat_qty_4"><input type="radio" name="angarconfig_input73" value="subcat_qty_4" {if $css73 == subcat_qty_4}checked{/if}>{l s='4 categories per row' mod='angarthemeconfigurator'}</label></br>
			<label class="subcat_qty_5"><input type="radio" name="angarconfig_input73" value="subcat_qty_5" {if $css73 == subcat_qty_5}checked{/if}>{l s='5 categories per row' mod='angarthemeconfigurator'}</label></br>
			<label class="subcat_qty_6"><input type="radio" name="angarconfig_input73" value="subcat_qty_6" {if $css73 == subcat_qty_6}checked{/if}>{l s='6 categories per row' mod='angarthemeconfigurator'}</label></br>
		</div>
	...
	<div class="customization_title" data-toggle="collapse" data-parent="#accordion" data-target="#customization_box20">{l s='Dual prices - display price with tax and without tax' mod='angarthemeconfigurator'}</div>
	<div id="customization_box20" class="collapse customization_container">

		{if $demo == 1}
			<div class="must_save"><sup>*</sup> {l s='If you don\'\t see changes in some modules, please clear the PrestaShop cache in backoffice' mod='angarthemeconfigurator'}</div>
		{/if}

		<div class="pl_dual_prices">
			<label class="options_title">{l s='Price display mode in the product-list:' mod='angarthemeconfigurator'}{if $demo == 1} <sup>*</sup>{/if}</label></br>
			<label class="pl_price_default"><input type="radio" name="angarconfig_input74" value="pl_price_default" {if $css74 == pl_price_default}checked{/if}>{l s='Display only default price' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_price_incl_excl"><input type="radio" name="angarconfig_input74" value="pl_price_incl_excl" {if $css74 == pl_price_incl_excl}checked{/if}>{l s='Display price tax incl. + price tax excl.' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_price_excl_incl"><input type="radio" name="angarconfig_input74" value="pl_price_excl_incl" {if $css74 == pl_price_excl_incl}checked{/if}>{l s='Display price tax excl. + price tax incl.' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_price_incl_tax_excl"><input type="radio" name="angarconfig_input74" value="pl_price_incl_tax_excl" {if $css74 == pl_price_incl_tax_excl}checked{/if}>{l s='Display price tax incl. + tax + price tax excl.' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_price_excl_tax_incl"><input type="radio" name="angarconfig_input74" value="pl_price_excl_tax_incl" {if $css74 == pl_price_excl_tax_incl}checked{/if}>{l s='Display price tax excl. + tax + price tax incl.' mod='angarthemeconfigurator'}</label></br>
		</div>
		...
		<div class="product_dual_prices">
			<label class="options_title">{l s='Price display mode on the product page:' mod='angarthemeconfigurator'}</label></br>
			<label class="product_price_default"><input type="radio" name="angarconfig_input75" value="product_price_default" {if $css75 == product_price_default}checked{/if}>{l s='Display only default price' mod='angarthemeconfigurator'}</label></br>
			<label class="product_price_incl_excl"><input type="radio" name="angarconfig_input75" value="product_price_incl_excl" {if $css75 == product_price_incl_excl}checked{/if}>{l s='Display price tax incl. + price tax excl.' mod='angarthemeconfigurator'}</label></br>
			<label class="product_price_excl_incl"><input type="radio" name="angarconfig_input75" value="product_price_excl_incl" {if $css75 == product_price_excl_incl}checked{/if}>{l s='Display price tax excl. + price tax incl.' mod='angarthemeconfigurator'}</label></br>
			<label class="product_price_incl_tax_excl"><input type="radio" name="angarconfig_input75" value="product_price_incl_tax_excl" {if $css75 == product_price_incl_tax_excl}checked{/if}>{l s='Display price tax incl. + tax + price tax excl.' mod='angarthemeconfigurator'}</label></br>
			<label class="product_price_excl_tax_incl"><input type="radio" name="angarconfig_input75" value="product_price_excl_tax_incl" {if $css75 == product_price_excl_tax_incl}checked{/if}>{l s='Display price tax excl. + tax + price tax incl.' mod='angarthemeconfigurator'}</label></br>
		</div>
