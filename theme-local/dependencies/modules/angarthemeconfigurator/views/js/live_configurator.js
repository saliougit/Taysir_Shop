...
// Delete below
	...
	// Footer style
	var removeFooterStyle = 'footer_style_1 footer_style_2 footer_style_3';
	$('#theme_customization .footer_style_1').on('click',function(){ $('body').removeClass(removeFooterStyle); $('body').addClass('footer_style_1'); });
	$('#theme_customization .footer_style_2').on('click',function(){ $('body').removeClass(removeFooterStyle); $('body').addClass('footer_style_2'); });
	$('#theme_customization .footer_style_3').on('click',function(){ $('body').removeClass(removeFooterStyle); $('body').addClass('footer_style_3'); });
	// Footer style
