...
class Angarthemeconfigurator extends Module
{
    ...
    public function install()
    {
        return parent::install()
            ...
            // Menu
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_CSS41', 'menu_sep1')
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_CSS43', 'slider_full_width')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_CSS8', 'slider_controls_black')
            ...
            // Products per row
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_CSS16', 'pl_1col_qty_4')
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR4', '#222222') // Top bar - font bold color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR5', '#222222') // Top bar - icons color

            // Header
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR6', '#ffffff') // Header - background

            // Search
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR7', '#ffcf00') // Search button - background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR78', '#222222') // Search button - font color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR8', '#ffcf00') // Search button - background hover
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR79', '#222222') // Search button - font color hover

            // Cart
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR9', '#ffcf00') // Cart - background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR80', '#222222') // Cart - font color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR86', '#ffcf00') // Sticky cart - background / not used
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR87', '#f8653d') // Sticky cart - background qty / not used
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR88', '#222222') // Sticky cart - font color / not used
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR59', '#f6691e') // Account icon

            // Menu
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR11', '#222222') // Menu - background
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR14', '#222222') // Menu - font color hover
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR15', '#ffcf00') // Menu - background hover
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR16', '#ffcf00') // Submenu layout 2 background hover
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR81', '#222222') // Submenu layout 2 color hover

            // Slider
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR10', '#ffcf00') // Slider active dot

            // Featured categories
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR60', '#222222') // Module header - background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR61', '#222222') // Category name - background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR62', '#ffcf00') // Subcategory button - background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR63', '#222222') // Subcategory button - font color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR64', '#ffcf00') // Subcategory button - border-color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR65', '#222222') // Subcategory button hover - background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR66', '#ffffff') // Subcategory button hover - font color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR67', '#222222') // Subcategory button - border-color hover

            // Left/right column
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR17', '#222222') // Modules header - background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR18', '#222222') // Price left column not used

            // Homepage products layout
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR19', '#222222') // Blocks with products header - background

            // Product-list
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR20', '#ffcf00') // New label background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR21', '#282828') // Product name - font color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR22', '#ee0000') // Price color in product-list
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR23', '#ffcf00') // "Add to cart" button - background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR24', '#000000') // "Add to cart" button - font color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR25', '#ffcf00') // "Add to cart" button - border-color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR26', '#222222') // "Add to cart" button - background hover
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR27', '#ffffff') // "Add to cart" button - font color hover
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR28', '#222222') // "Add to cart" button - border-color hover

            // Products from category
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR68', '#222222') // Module header - background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR69', '#222222') // Price color - not used
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR70', '#00b0ff') // New label - not used

            // Featured manufacturers
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR71', '#222222') // Module header - background

            // Footer
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR29', '#ffcf00') // Icons before footer color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR30', '#222222') // Footer - background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR31', '#363636') // Footer - border color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR32', '#ffcf00') // Footer - modules header border color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR33', '#ffffff') // Footer - font color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR36', '#222222') // Footer bottom - background
            ...
            // Footer
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR34', '#ffcf00') // Newsletter button - background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR82', '#222222') // Newsletter button - color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR35', '#ffcf00') // Newsletter button - background hover
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR83', '#222222') // Newsletter button - color hover

            // Product page
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR39', '#ee0000') // Price color product page
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR40', '#222222') // "Add to cart" button - background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR41', '#ffffff') // "Add to cart" button - font color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR42', '#222222') // "Add to cart" button - border-color
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR46', '#222222') // Selected tab background
            ...
            // Scroll to top
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR76', '#ffcf00') // Scroll to top background
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR84', '#222222') // Scroll to top font color
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR77', '#222222') // Scroll to top hover background
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR73', '#ffcf00') // Pagination active page / P16-P17 differences
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR74', '#222222') // Icons on my account page / P16-P17 differences
    ...
    public function renderForm()
    {
        $fields_form = array(
            'form' => array(
                ...
                $this->l('If you need help with theme configuration, please send me a message on addons.prestashop.com here: https://addons.prestashop.com/en/contact-us?id_product=30027'),
                'input' => array(
