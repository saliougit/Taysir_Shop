          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              {if $criterions|@count > 0}
                <ul id="criterions_list">
                  {foreach from=$criterions item='criterion'}
                    <li>{* AngarTheme - productcomments mod *}
			  ...
			  <div class="row">
				...
				<div class="col-sm-6 post-comment-buttons">{* AngarTheme - productcomments mod *}
				  <button type="button" class="btn btn-comment-inverse btn-comment-big btn-secondary" data-dismiss="modal">
