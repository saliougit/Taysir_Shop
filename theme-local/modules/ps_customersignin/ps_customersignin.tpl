...
<div id="_desktop_user_info">
  <div class="user-info">
	...
	<a class="angar-account-icon" href="{if $logged}{$my_account_url}{else}{$my_account_url}{/if}" title="{l s='View my customer account' d='Shop.Theme.Customeraccount'}" rel="nofollow">
		{include file='_partials/icons/person.tpl'}
	</a>
