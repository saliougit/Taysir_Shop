                        ...
                        <div class="comment clearfix">
                            <div class="comment_author">
                                ...
                                <div class="comment_author_infos">
                                    ...
                                    <em content="{dateFormat date=$comment.date_add|escape:'html':'UTF-8' full=0}">{dateFormat date=$comment.date_add|escape:'html':'UTF-8' full=0}</em>
                                </div>
                            </div>
                    ...
                    {if isset($product) && $product}
                        <div class="product clearfix">
                            <div class="product_desc">
								<img src="{if !empty($productcomment_cover_image)}{$productcomment_cover_image}{else}{$urls.img_url}en-default-home_default.jpg{/if}" alt="{$productcomment_name}" />
                                <p class="product_name"><strong>{$productcomment_name}</strong></p>
                                {$productcomment_desc nofilter}
                            </div>
                        </div>
                    {/if}
