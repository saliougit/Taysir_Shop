...
class AngarFastconfig extends Module
{
    ...
    public function renderConfigurationForm()
    {
        ...
        $fields_form = array(
            'form' => array(
                ...
                'description' => $this->l('If you need help with theme configuration, please send me a message on addons.prestashop.com here: https://addons.prestashop.com/en/contact-us?id_product=30027').'<br/>'.
    ...
    protected function getConfigurableModules()
    {
        return array(
            ...
            array(
                'label' => $this->l('AT - Cookie banner'),
                'name' => 'angarcookieinfo',
                'value' => (int)Validate::isLoadedObject($module = Module::getInstanceByName('angarcookieinfo')) && $module->isEnabledForShopContext(),
                'is_module' => true,
            ),

            array(
                'label' => $this->l('AT - Whatsapp'),
                'name' => 'angarwhatsapp',
                'value' => (int)Validate::isLoadedObject($module = Module::getInstanceByName('angarwhatsapp')) && $module->isEnabledForShopContext(),
                'is_module' => true,
            ),
